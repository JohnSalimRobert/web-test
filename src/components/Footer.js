...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-800 text-white">
      <div className="flex flex-col md:flex-row justify-around items-start md:items-center mb-4 bg-custom-yellow rounded-t-3xl pb-20 pt-10">
        {/* First Div */}
        <div className="flex flex-col max-w-xs">
            <img className='max-w-[60%]' src={logo} alt='Company Logo'></img>
          <div className="text-md font-bold max-w-[80%]">Bringing more buzz to 
your brand!
</div>
        </div>
        <div className="flex flex-col space-y-2 md:ml-12">
          <ul className="text-md">
        {links.map((link, index) => (
          <li key={index} className='hover:text-gray'>
        ...
        <div className="flex flex-col space-y-2 md:ml-12">
          ...
          <FontAwesomeIcon icon={faPhoneVolume} /> &nbsp;
             0992 320982</p>
          <p className="text-sm"><FontAwesomeIcon icon={faEnvelope} /> &nbsp; bee@gmail.com</p>
        </div>
      </div>
      <div className="flex flex-col md:flex-row justify-around items-start md:items-center mb-4">
        {/* Second Div */}
        <div><h1 className='text-md font-bold pb-2'>You can find us on:</h1>
        <div className="flex space-x-4">           
          <a href="#" className="w-12 h-12 flex items-center justify-center rounded-full border-4 border-custom-yellow hover:bg-gray-light">
        ...
        <p className="text-md md:ml-12 text-left"> <FontAwesomeIcon icon={faLocationDot} size="xl"/> &nbsp;
            Yeoford Way, Marsh Barton, Exeter EX5 8MP, 
United Kingdom
</p>
      </div>
      <div className="text-center bg-custom-yellow py-10 ">
        {/* Third Div */}
        <p className="text-lg">&copy; Copyright wannabee digital 2022. All Right Reserved</p>
      </div>
    </footer>
  );
};
